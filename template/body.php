...
<td style="display:flex;justify-content:center;align-items:center;">
  <div style="LEFT: 0px; TOP: 0px; WIDTH: 600px; POSITION: relative;">
      <table cellpadding="0" cellspacing="0"><tbody><tr></tr>
        <td><img src="<?= $holiday ? $edge_a : 'img/edge_a.jpg' ?>" width="100" height="43" hspace="0" vspace="0"></td>
        <td><img src="img/edge_c.jpg" width="400" height="42" hspace="0" vspace="0"></td>
        <td><img src="<?= $holiday ? $edge_d : 'img/edge_d.jpg' ?>" width="100" height="43" hspace="0" vspace="0"></td>
      </tr></tbody></table>
      <table width="600" cellpadding="0" cellspacing="0" background="<?= $holiday ? $background : 'img/background2.jpg' ?>">
      <tbody>
        <tr>
