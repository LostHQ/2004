...
<table class="calculators">
    ...
    <tr>
        <td><canvas data-itemname="baxtorian_key_waterfall_quest" data-show-label="true"></canvas></td>
        <td>Opens a cage to get Glarial's Pebble. (Waterfall Quest)</td>
        <td>Search a crate in the dungeon under Tree Gnome Village.</td>
        <td>❌</td>
    </tr>
    <tr>
        <td><canvas data-itemname="elenakey" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="elemental_workshop_key" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="thbedobinkey" data-show-label="true"></canvas></td>
        <td>Used in the Tourist Trap Quest to steal blueprints from Captain Siad.</td>
        <td>Obtained from Al Shabim.</td>
        <td>❌</td>
    </tr>
    <tr>
        <td><canvas data-itemname="zqbonekey" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="bonekey" data-show-label="true"></canvas></td>
    ...
    -->
    <tr>
        <td><canvas data-itemname="edgevilledungeonkey" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="cavernkey" data-show-label="true"></canvas></td>
    ...
    -->
    <tr>
        <td><canvas data-itemname="thcelldoorkey" data-show-label="true"></canvas></td>
        <td>Opens a cell door in the Tourist Trap Quest.</td>
        <td>Steal it from the room upstairs of the cell.</td>
        <td>❌</td>
    </tr>
    <tr>
        <td><canvas data-itemname="chest_key" data-show-label="true"></canvas></td>
        <td>Opens Red Beard Frank's chest.</td>
        <td>Pirate's Treasure Quest.</td>
        <td>❌</td>
    </tr>
    <tr>
        <td><canvas data-itemname="digchestkey" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="ghostchestkey" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="closetkey" data-show-label="true"></canvas></td>
    ...
    -->
    <tr>
        <td><canvas data-itemname="crystal_key" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="crystalminekey" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="displaykey" data-show-label="true"></canvas></td>
    ...
    -->
    <tr>
        <td><canvas data-itemname="witches_doorkey" data-show-label="true"></canvas></td>
        <td>Opens the door in the Witch's House Quest.</td>
        <td>Found under a flower pot in Taverly, out side the witches house.</td>
        <td>❌</td>
    </tr>
    <tr>
        <td><canvas data-itemname="dusty_key" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="frozen_key" data-show-label="true"></canvas></td>
    ...
    -->
    <tr>
        <td><canvas data-itemname="grandtree_gloughskey" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="golden_key" data-show-label="true"></canvas></td>
    ...
    -->
    <tr>
        <td><canvas data-itemname="keyhalf1" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="keyhalf2" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="iron_key" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="keys" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="lighthouse_key" data-show-label="true"></canvas></td>
    ...
    -->
    <tr>
        <td><canvas data-itemname="melzarkey" data-show-label="true"></canvas></td>
        <td>To gain access to Melzar's Maze.</td>
        <td>Given by the Guildmaster in the Champions' Guild during Dragon Slayer.</td>
        <td>➖</td>
    </tr>
    <tr>
        <td><canvas data-itemname="muddy_key" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="seers_key" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="shed_key" data-show-label="true"></canvas></td>
    ...
    -->
    <tr>
        <td><canvas data-itemname="ikov_shinykey" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="shade_keys" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="storeroom_key" data-show-label="true"></canvas></td>
    ...
    -->
    <tr>
        <td><canvas data-itemname="thgoodminekey" data-show-label="true"></canvas></td>
    ...
    <tr>
        <td><canvas data-itemname="zealots_key" data-show-label="true"></canvas></td>
