...
<div id="narrowscroll">
    ...
    <li><div data-progress><canvas itemname="steel_axe" show-label="inline" name-replace="Any woodcutting axe"></canvas></div></li>
    <li><div data-progress><canvas itemname="feather" show-label="inline" amount="100" name-replace="About 100 feathers"></canvas></div></li>
    <li><div data-progress><canvas itemname="wolf_bones" show-label="inline" name-replace="About 4-5 wolf bones"></canvas></div></li>
    </ul>
    <h3>Recommended:</h3>
    <ul style="list-style-type: none;">
...
<br><br>
<img src="img/questimages/bigchomp/bigchomp1.png">
<br>
<img src="img/questimages/bigchomp/bigchomp2.png">
<br><br>
...
<br><br>
<img src="img/questimages/bigchomp/bigchomp3.png">
<br><br>
...
<br><br>
<img src="img/questimages/bigchomp/bigchomp4.png">
<br><br>
<div data-progress>You will need 3-6 wolves to make enough arrows. You need at least 12-15 tips.</div>
<br><br>
<div data-progress>Use your Chisel with the bones to make some arrow tips out of the bones. You can make from 2-6 arrow tips from each set of bones.</div>
<br><br>
<div data-progress>Add your arrow tips to the arrow shafts that you previously placed feathers on.</div>
<br><br>
<div data-progress>You will need to make 6 or more, when you have made the arrows, go talk to Rantz. If you are smart, you make 12 or more arrows because you will need some later when you have to kill the Chompy for Rantz. You can make as many as you want because you can use the arrows later to increase your Chompy Bird hunter level. Right click on the bow to check the level.</div>
<br><br>
...
<br><br>
<img src="img/questimages/bigchomp/bigchomp5.png">
<br>
<img src="img/questimages/bigchomp/bigchomp6.jpg">
<br><br>
<div data-progress>When you finish talking to them, go search the Chest in the north west of the cave.</div>
<br><br>
<div data-progress>You will get an Ogre Bellows, now go to the swamp just west of Rantz, there is some bubbles coming out of the swamp, use the bellows with the bubbles and you will fill the bellows with gas.</div>
<br><br>
<div data-progress>Now use the bellows with the Swamp toads around the area, The toad will fill with gas and grow big and then the toad will automatically get placed in your inventory. You will need 3 toads full of gas. (You can't get more than 3 at a time)</div>
<br><br>
...
<br><br>
<img src="img/questimages/bigchomp/bigchomp7.jpg">
<br><br>
...
<br><br>
<img src="img/questimages/bigchomp/bigchomp8.png">
<br><br>
...
<br><br>
<img src="img/questimages/bigchomp/bigchomp9.png">
<br><br>
The food items can be found around the Ogre city area and around the area where Rantz is:
<br>
<div data-progress>The Onions and Tomatoes are just west of the swamp with the toads.</div>
<br>
<div data-progress>The Cabbage is in various locations including just north of the swamps with the toads, and around the equa leaves.</div>
<br>
...
<br><br>
<div data-progress>When you have cooked the bird, go to Rantz and talk to him.</div>
$questComplete
<span id="zombiemusiq"></span>
<iframe width="450" height="253" src="https://www.youtube.com/embed/5cgpi7BZgfU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
<hr>
