...
<div id="narrowscroll">
    ...
    <li><div data-progress><canvas itemname="yew_shortbow" show-label="inline" name-append=" or better"></canvas></div></li>
    <li><div data-progress><canvas itemname="limpwurt_root" show-label="inline" name-replace="20 limpwurt roots"></canvas></div></li>
    <li><div data-progress><canvas itemname="lit_candle" show-label="inline" name-replace="A light source"></canvas></div></li>
    <li><div data-progress><canvas itemname="knife" show-label="inline" name-replace="Something to cut webs (knife/slash weapon)"></canvas></div></li>
    ...
    <li><div data-progress><canvas itemname="dragonhide_body" show-label="inline" name-replace="Dragon leather ranged armour"></canvas></div></li>
    <li><div data-progress><canvas itemname="lawrune" show-label="inline" name-replace="Varrock and Ardougne teleports"></canvas></div></li>
...
<br><br>
<div data-progress>Put on the pendant and get ready to go to the dungeon. Get a candle from the Catherby Candle shop, and light it with a tinderbox.</div>
<br><br>
The things you should bring on this (1st) trip:
<br>
<div data-progress>The Pendant of Lucien (never take this off)</div><br>
<div data-progress>Your lit candle</div><br>
<div data-progress>A knife</div><br>
<br>
...
<br><br>
<img src="img/questimages/ikov/ikov1.gif" height="200" width="375">
<br><br>
...
<br><br>
<img src="img/questimages/ikov/ikov2.gif" height="200" width="300">
<br><br>
...
<br><br>
<img src="img/questimages/ikov/ikov3.gif" height="200" width="375">
<hr>
The things you should bring on this (2nd) trip:
<br>
<div data-progress>The Pendant of Lucien (never take this off)</div><br>
<div data-progress>Your melee resistant armor</div><br>
<div data-progress>Lots of food</div><br>
<div data-progress>The lever piece</div><br>
<br>
...
<br><br>
<img src="img/questimages/ikov/ikov4.gif" height="200" width="300">
<br><br>
...
<br><br>
<img src="img/questimages/ikov/ikov5.gif" height="200" width="375">
<br><br>
...
<br>
<div data-progress>The Pendant of Lucien (never take this off)</div><br>
<div data-progress>Magic resistant armor</div><br>
<div data-progress>The yew or magic bow</div><br>
<div data-progress>Lots of food</div><br>
...
<br><br>
<img src="img/questimages/ikov/ikov6.gif" height="200" width="300">
<hr>
The things you should bring on this (4th) trip:
<br>
<div data-progress>The Pendant of Lucien (never take this off)</div><br>
<div data-progress>Melee resistant armor</div><br>
<div data-progress>Weapon</div><br>
<div data-progress>Some food</div><br>
<div data-progress>20 limpwurt roots</div>
<br><br>
...
<br><br>
<img src="img/questimages/ikov/ikov7.gif" height="200" width="350">
<br><br>
...
<br><br>
<img src="img/questimages/ikov/ikov8.gif" height="200" width="350">
<br><br>
...
<br><br>
<img src="img/questimages/ikov/ikov9.gif" height="200" width="300">
<hr>
<b>Side with the Guardians</b>
<br><br>
<div data-progress>Take off your Pendant of Lucien. Talk to one of the Guardians of Armadyl. You'll tell them that you're working for a man named Lucien. They'll be quite disappointed and give you a pendant, telling you to kill him.</div>
<br><br>
...
<br><br>
<img src="img/questimages/ikov/ikov10.gif" height="200" width="350"><br>
<br>
<div data-progress>Wearing your pendant attack him (he's only level 14). You will be rewarded once you kill him.</div>
<hr>
<b>Side with Lucien</b>
<br><br>
<div data-progress>There is a small room within the larger room that contains the staff. When you try to take it, the nearby Guardians (level 36-40) will attack you. Pick it up once all of them are dead. Leave the big room and go up the ladder near you.</div>
<br><br>
<div data-progress>You will find yourself in a room just north of McGrubbor's Wood. Use your shiny key on the door and you should go through. Go to Varrock, and exit via the northeast exit, follow the wall surrounding the castle, west then south, and you will see a house with Lucien in it.</div>
<br><br>
<div data-progress>Talk to him and give him the staff, you will be rewarded.</div>
<br><br>
