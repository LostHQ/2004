...
<div id="narrowscroll">
    ...
    <li><div data-progress><canvas itemname="bat_bones" show-label="inline" name-append=" (can be obtained during quest)"></canvas></div></li>
    <li><div data-progress><canvas itemname="bucket_wax" show-label="inline" name-append=" (can be obtained during quest)"></canvas></div></li>
    <li><div data-progress><canvas itemname="tinderbox" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="bread" show-label="inline"></canvas></div></li>
...
<br><br>
<div data-progress>Go upstairs, then talk to Sir Lancelot and ask him if he has any ideas to get into the Keep Le Faye stronghold.</div>
<br><br>
<div data-progress>Stop by either Camelot or Catherby bank and equip yourself with gear and/or food to fight a level 39 knight.</div>
<br><br>
...
<br><br>
<div data-progress>If you do not already have bat bones, kill a giant bat just outside of Keep Le Faye and pick up bat bones.</div>
<br><br>
