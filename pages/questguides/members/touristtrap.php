...
<div id="narrowscroll">
    ...
    <li><div data-progress><canvas itemname="desert_shirt" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="desert_robe" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="desert_boots" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="shantay_pass" show-label="inline"></canvas></div></li>
    ...
    <li><div data-progress><canvas itemname="feather" show-label="inline" name-replace="10 feathers"></canvas></div></li>
    ...
    <li><div data-progress><canvas itemname="water_skin4" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="bronze_bar" show-label="inline" name-replace="3 bronze bars"></canvas></div></li>
    <li><div data-progress><canvas itemname="feather" show-label="inline" name-replace="50 feathers"></canvas></div></li>
...
<br><br>
<div data-progress>After Irena tells you about her daughter Ana, she leaves you to find her on your own. Go south a little and examine the footsteps. They hint that you should head south (slightly west as well) to the Mining Camp. (MAKE SURE you find the Kharidian Cactus & cut them to keep water in your Waterskin[s].)</div>
<br><br>
<div data-progress>Talk to the Mercenaries around there until you get them to admit that they don't like the Captain. This will cost you 5gp per bribe. Find out that the Captain doesn't like to fight his own battles. (If you get caught, they will take you to the desert and confiscate all but one waterskin.)</div>
<br><br>
<div data-progress>Now talk to the Captain, get him roused until he tells you he will call his Guards. Pick the option about asking him to fight his own fights. Then he challenges you. Once he's dead a Metal Key will be added to your inventory. Use this to go inside with NO armor or weapons equipped! (ONCE you've killed the Captain you can come here to kill him again and get the key without all the dialogue.)</div>
<br><br>
<div data-progress>Talk to the male slave who is trying to escape. After some conversation trade clothes with him. You will have to speak to him a second time to do so. (IF you get caught inside the camp the Guards & Mercenaries may throw you in jail.) The Cell Key can be found upstairs in Captain Siad's desk.</div>
<br><br>
<div data-progress>Now with your slave outfit on go downstairs through the huge door and follow the path to the TWO Mercenaries. Talk to one and ask him to let you trade spots. He will hint at you getting a Pineapple for him first. (MAKE SURE you don't have armor or weapons on around the Mercenaries.)</div>
<br><br>
<div data-progress>Leave the camp completely. Go directly west until you find the Nomads' Camp. Talk to Al Shabim until you can ask him for a Pineapple. He will reveal the plan to get Blueprints from Captain Siad. Agree and he will give you a copy of the Chest Key. Now head back to the Mining Camp. (NOTE you can get more supplies from the nomads.)</div>
<br><br>
...
<br><br>
<div data-progress>Take this to Al Shabim and he will give you the Pineapple and Six Darts. You now also have the ability to make DARTS! Go back to the Mining Camp.</div>
<br><br>
<div data-progress>Go through the gates with NO Armor or Weapons equipped. Then down to the mines. Give the Pineapple to the Mercenary and go through the Mine Cave.</div>
<br><br>
<div data-progress>Close to the mine cart is a bunch of Barrels. Search an empty one and take it. Now get in the mine cart. This may take a few tries depending on your agility level. (MAKE SURE you have food because you will get hurt.)</div>
<br><br>
