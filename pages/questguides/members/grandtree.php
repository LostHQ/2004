...
<div id="narrowscroll">
    ...
    <li><div data-progress><canvas itemname="coins_25" show-label="inline" name-replace="30 coins"></canvas></div></li>
    ...
    <li><div data-progress><canvas itemname="lawrune" show-label="inline" name-replace="Runes for Teleport to Watchtower/Ardougne"></canvas></div></li>
    ...
    <li><div data-progress><canvas itemname="lobster" show-label="inline" name-replace="Lobster or better food (if using melee)"></canvas></div></li>
    </ul>
