...
<div id="narrowscroll">
    ...
    <ul style="list-style-type: none;">
        ...
        <li><div data-progress><canvas itemname="ruby" show-label="inline" name-replace="2 Cut rubies"></canvas></div></li>
        <li><div data-progress><canvas itemname="steel_pickaxe" show-label="inline" name-replace="Any Pickaxe"></canvas></div></li>
        <li><div data-progress><canvas itemname="shrimp" show-label="inline"></canvas></div></li>
        <li><div data-progress><canvas itemname="salmon" show-label="inline"></canvas></div></li>
        <li><div data-progress><canvas itemname="tuna" show-label="inline"></canvas></div></li>
        <li><div data-progress><canvas itemname="bass" show-label="inline"></canvas></div></li>
        <li><div data-progress><canvas itemname="swordfish" show-label="inline"></canvas></div></li>
        <li><div data-progress><canvas itemname="ring_mould" show-label="inline"></canvas></div></li>
        <li><div data-progress><canvas itemname="necklace_mould" show-label="inline"></canvas></div></li>
        <li><div data-progress><canvas itemname="3doseantipoison" show-label="inline" name-replace="Any antipoison potion"></canvas></div></li>
        <li><div data-progress><canvas itemname="deathrune" show-label="inline" name-replace="4 Death runes"></canvas></div></li>
        <li><div data-progress><canvas itemname="airrune" show-label="inline" name-replace="13 Air runes"></canvas></div></li>
        <li><div data-progress><canvas itemname="waterrune" show-label="inline" name-replace="3 Water runes"></canvas></div></li>
        <li><div data-progress><canvas itemname="earthrune" show-label="inline" name-replace="4 Earth runes"></canvas></div></li>
        <li><div data-progress><canvas itemname="firerune" show-label="inline" name-replace="5 Fire runes"></canvas></div></li>
    </ul>
    <h3>Recommended:</h3>
    <ul style="list-style-type: none;">
        ...
        <li><div data-progress><canvas itemname="3doseantipoison" show-label="inline" name-replace="Another Antipoison potion"></canvas></div></li>
        <li><div data-progress><canvas itemname="lobster" show-label="inline" name-replace="Food"></canvas></div></li>
        <li><div data-progress><canvas itemname="lawrune" show-label="inline" name-replace="Runes for Teleport to Ardougne or Camelot"></canvas></div></li>
...
<br>
<img src="img/questimages/famcrest/famcrest1.jpg"><img src="img/questimages/famcrest/famcrest2.jpg"><br>
<br>
...
<hr>
<h3>First Son:</h3>
<img src="img/questimages/famcrest/famcrest3.jpg"><img src="img/questimages/famcrest/famcrest4.jpg">
<br><br>
...
Swordfish<br>
<br>
<div data-progress>Give him these fish and he will give you his piece of the crest. He should tell you about the second brother in Al Kharid. If he doesn't, talk to him again and he will tell you to go to the Gem Trader in Al Kharid.</div>
<br>
<hr>
<h3>Second Son:</h3>
<div data-progress>Talk to the Gem Trader in Al Kharid. He will tell you about a man with a poncey yellow cape who hangs around the gold rock in the Scorpion Pit Chasm mine north of Al Kharid.</div>
<br>
...
<br>
<img src="img/questimages/famcrest/famcrest5.jpg"><img src="img/questimages/famcrest/famcrest6.jpg">
<br><br>
...
<br>
<img src="img/questimages/famcrest/famcrest7.jpg"><img src="img/questimages/famcrest/famcrest9.jpg">
<br><br>
...
<div style="text-align:left;">
    ...
    <div data-progress>II) Back to the South room and pull that lever down</div>
    <div data-progress>III) Back to the North wall and pull the lever down</div>
    <div data-progress>IV) Go inside the North room and pull that lever up</div>
    <div data-progress>V) Go outside of the room and pull the lever on the North wall up</div>
    <div data-progress>VI) Go back to the South room and pull that lever down</div>
...
<br>
<img src="img/questimages/famcrest/famcrest10.jpg">
<br><br>
...
<br>
<div data-progress>Return to Al Kharid with your ruby ring and ruby necklace made from the finest gold and give them to the Nobleman. He will give you his piece and tell you about his younger brother.</div>
<br>
<hr>
<h3>Third Son:</h3>
<br>
...
<br>
<img src="img/questimages/famcrest/famcrest11.jpg"><img src="img/questimages/famcrest/famcrest12.jpg"><br>
<br>
...
<br><br>
<img src="img/questimages/famcrest/edgedung.png">
<br><br>
...
<br><br>
<div data-progress>Go through the gate and you will first meet some thugs (level 10). Head west and get past the Chaos Druids (level 13). Go north and get past the skeletons (level 45) by heading west into the narrow hallway.</div>
<br><br>
<div data-progress>You will need to get past Black Demons (level 172) and Poison Spiders (level 64). Once you feel ready, go west, then south.</div>
<br><br>
...
<br><br>
<img src="img/questimages/famcrest/famcrest13.jpg">
<br><br>
<hr>
<h3>Finishing Up:</h3>
<div data-progress>Finishing the Quest: Now that you have all three pieces, put them together and go back and talk to Dimintheis. He will be grateful and will reward you. You can have them enhanced—see below. Remember, you can only choose one enhancement, so choose wisely.</div>
<br><br>
Enhancing the Gauntlets: Go to any son and talk to him. He will enhance the gauntlets for you if you want.
<br>
<img src="img/questimages/famcrest/famcrest11.png" width="450">
$questComplete
