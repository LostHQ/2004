...
<div id="narrowscroll">
    ...
    <li><div data-progress><canvas itemname="fishing_bait" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="harralandervial" show-label="inline" name-append=" (or a harralander and vial of water)"></canvas></div></li>
    ...
    <ul style="list-style-type: none;">
    <li><div data-progress><canvas itemname="black_full_helm" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="black_platebody" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="black_platelegs" show-label="inline"></canvas></div></li>
    </ul>
    ...
    <li><div data-progress><canvas itemname="dusty_key" show-label="inline"></canvas></div></li>
