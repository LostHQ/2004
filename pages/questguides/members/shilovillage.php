...
<li><div data-progress><canvas itemname="bronzecraftwire" icon-size="25" show-label="inline"></canvas></div><br></li>
<li><div data-progress><canvas itemname="chisel" icon-size="25" show-label="inline"></canvas></div><br></li>
<li><div data-progress><canvas itemname="torch_lit" icon-size="25"></canvas>&nbsp;&nbsp;A lit torch or <canvas itemname="lit_candle" icon-size="25"></canvas>&nbsp;a lit candle</div><br></li>
<li><div data-progress><canvas itemname="bones" icon-size="25"></canvas>&nbsp;&nbsp;3 bones</div><br></li>
...
<br><br>
<div data-progress>Trufitus is located north of this village. After you have found him, talk to him and tell him about Rashiliyiaand that she has returned. Give him the belt and ask ALL the questions; otherwise, you can't proceed to the next part. He will tell you about the Legend and the Temple of Ah-za rhoon. Tell him that you will search the temple.</div>
<br><br>
<div data-progress>The temple is located east of Trufitus' house. Head east until you see a river. Now head south until you see a log. Walk across it and go south. You will see a Mound of Earth. Warning: There are many level 60 undead in this cave! Search it and use the spade on it, after that use your candle on it. Finally use rope. Then search again to drop down.</div>
<br><br>
<div data-progress>Walk south a short distance, and you will find a cave-in. After you have found it, search it and wriggle through.</div>
<br><br>
<div data-progress>Walk north and you will find some loose rocks on the northwest corner. Search them and you will find a Tattered Scroll. Keep it.</div>
<br><br>
<div data-progress>Walk southeast until you find a small room. Search the old sacks and you will get a Crumpled Scroll. Keep it.</div>
<br><br>
<div data-progress>Walk north and you will see an Ancient gallows. Search it and you will get a Zadimus' Corpse. Keep it.</div>
<br><br>
<div data-progress>Go back to the first cave. Try to craft the table into a raft. You'll notice there isn't enough wood. Walk southeast and you will find a waterfall. Search it and climb up (It doesn't matter if you fall.)</div>
<br><br>
<div data-progress>Return to Trufitus and give him all the items (use the items on him). He will tell you to bury the corpse in front of the Tribal Statue. After talking to him, read all the scrolls.</div>
<br><br>
<div data-progress>Bury the corpse in front of the statue. Zadimus will appear and give you a Bone Shard. Give this to Trufitus. He will tell you about a tomb.</div>
<br><br>
<div data-progress>The tomb is located southwest of the house (Next to Shilo Village, but before you reach it, you'll need to climb some rocks and cross a bridge.) After you have found the rocks, climb them and cross the river. If you failed, try again.</div>
<br><br>
<div data-progress>After you crossed the bridge, head a bit north and search the rock. You will drop down.</div>
<br><br>
<div data-progress>Head south and you will see a dolmen. Search it and you will get a sword pommel, a locating crystal and Bervirius notes. Go to the east room of this tomb and climb the rocks to go back out.</div>
<br><br>
<div data-progress>Return to Trufitus and give him all the items. He will tell you that you will need a bronze necklace.</div>
<br><br>
<div data-progress>Go a bit northwest of the house. You will find an anvil. You will need a chisel, a hammer, and a bronze bar. If you don't, go the shop and buy them. The shop is located south of this anvil.</div>
<br><br>
<div data-progress>Use the bronze bar on the anvil and make a bronze wire. Use chisel on the sword pommel. Finally use the beads on the bronze wire. You will get an amulet called "Beads of the Dead." Show this to Trufitus.</div>
<br><br>
<div data-progress>Before doing step 18, equip your armor, bring some food, recharge your prayer points, and probably bring some potions.</div>
<br><br>
<div data-progress>Go east of the house. Find the log that you have crossed before. Cross it and go north a bit. Find a palm tree that you can search. After you have found it, search the palm tree and a door will appear. Use your chisel on the bone shard and you will craft it into a key. Wear your Beads of the Dead amulet and use the key on the doors to get in.</div>
<br><br>
<div data-progress>Go south and open the gate. Climb the rocks and go west. You will find a door. Use 3 bones on the door and the door will open.</div>
<br><br>
