...
<div id="narrowscroll">
    ...
    <li><div data-progress><canvas itemname="cheese" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="leather_gloves" show-label="inline"></canvas></div></li>
    </ul>
