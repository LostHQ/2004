...
<div id="narrowscroll">
    ...
    <li><div data-progress><canvas itemname="black_bead" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="red_bead" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="white_bead" show-label="inline"></canvas></div></li>
    <li><div data-progress><canvas itemname="yellow_bead" show-label="inline"></canvas></div></li>
    </ul>
