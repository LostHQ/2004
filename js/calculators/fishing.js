const fishes = {
    ...
    tbwt_raw_karambwanji: { xp: 5, level: 5 },
    ...
    mort_slimey_eel: { xp: 65, level: 28 },
    ...
    tbwt_raw_karambwan: { xp: 105, level: 65 },
    raw_shark: { xp: 110, level: 76 },
    //raw_seaturtle: { xp: 57, level: 79 }, (only available from trawler right now)
    //raw_mantaray: { xp: 69, level: 81 }, (only available from trawler right now)
};
