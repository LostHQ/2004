...
function runCalc() {
    ...
    switch (mode) {
        ...
        case "banked": {
            ...
            const herbs = Object.keys(herbloreData.herbs);
            ...
            for (let i = 0; i < herbs.length; i++) {
                ...
                if (potionsUsing.length > 1) {
                    ...
                    potionsUsing.forEach((potionKey) => {
                        ...
                        opt.value = potionKey;
                        opt.textContent = window.itemData[potionKey].name;
            ...
            button.addEventListener("click", function () {
                ...
                herbs.forEach((herb) => {
                    ...
                    const prettyHerbName = window.itemData[herb].name;
                    let identifyingXPAdded = false;
                    if (!herbsCleaned && amount > 0) {
                        const identifyingXP = herbloreData.herbs[herb].xp;
                    ...
                    if (selectedPotion) {
                        ...
                        const prettyPotionName = window.itemData[selectedPotion].name;
                        ...
                        potionsUsing.forEach((potionKey) => {
                            ...
                            if (allowedAmount === 0) return;
                            const xpPer = recipe.xp;
                            const prettyPotionName = window.itemData[potionKey].name;
                            const total = allowedAmount * xpPer;
                            totalXP += total;
                            xpAfter += total;
                            const secondary = recipe.secondary;
                ...
                if (secondaryListArr.length > 0) {
                    ...
                    secondaryListArr.forEach(([sec, count]) => {
                        ...
                        trSec.innerHTML = `<td>${window.itemData[sec].name}</td><td>${count}</td>`;
